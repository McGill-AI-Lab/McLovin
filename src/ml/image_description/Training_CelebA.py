...
#Defining the datasets for training
train_dataset = torchvision.datasets.CelebA(root='./src/ml/image_description/data', split='train', target_type='attr',
                                             download=True, transform=transform)

#Creating the custom dataset for training (ie removing irrelevant columns)
